...
<div align="center">
  ...
  <div style="text-align: left;">
    ...
    <h3 font color="red" id="title">My name is Muhamad Nurfadli 🤓</h3>
    <h3 id="title">I'm from Indonesia 🇮🇩 🇮🇩</h3>
    <h3 id="title">I'm currently studying at SMKN 1 Batam (Vocational High School) 🏫</h3>
    <h3 id="title">Hearts of Iron 4 Player 🎖️</h3>
  </div>
</div>
